...
import time
st.set_page_config(page_title="InecGPT")
...
db = FAISS.load_local("inec_vector_db", embeddings, allow_dangerous_deserialization=True)
...
TOGETHER_AI_API = '52d688a5bbdd2b8ac092305a005dc06b5c0628003a18c614bcd821127a32e3ff'
